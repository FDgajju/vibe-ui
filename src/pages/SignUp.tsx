  ...
  return (
    <div className="mx-auto max-w-7xl">
      <div className="mx-auto max-w-md bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6 sm:p-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center mb-6">Sign Up</h1>
        <form className="space-y-5">
          ...
          <p className="text-sm text-gray-600 text-center">Already have an account? <a href="/signin" className="font-semibold text-purple-700 hover:underline">Sign in</a></p>
        </form>
      </div>
    </div>
  );
